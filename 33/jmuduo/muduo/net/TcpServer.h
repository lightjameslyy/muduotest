...
class TcpServer : boost::noncopyable
{
 public:
  ...
  TcpServer(EventLoop* loop,
            const InetAddress& listenAddr,/*服务端口*/
            const string& nameArg);/*服务名称*/
 ...
 private:
  ...
  typedef std::map<string, TcpConnectionPtr> ConnectionMap;//连接名称，连接对象指针;
  ...
  ConnectionMap connections_;	// 维护连接列表
};
